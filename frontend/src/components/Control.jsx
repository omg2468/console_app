const Control = () => {
  return (
    <div className='w-full overflow-x-scroll h-full flex flex-row flex-1 p-2'>
      <div className='h-full w-full min-w-[300px] flex flex-1 flex-col gap-2 '>
              ...
              <table className='w-full'>
                <thead>
                  <tr>
                    ...
                    <th className='p-2 border-b text-left win-[150px] min-w-[150px]'>Value</th>
                  </tr>
                </thead>
              </table>
            </div>
            <div style={{ maxHeight: 310, overflowY: "auto", width: "100%" }}>
              <table className='w-full'>
                <tbody>
                  {Array.from({ length: 12 }, (_, index) => (
                    <tr key={index}>
                      <td className='border-r border-b p-2 text-right w-[150px]'>
                        Analog input {index + 1}
                      </td>
                      <td className='p-2 border-b text-left win-[150px] min-w-[150px]'>weaxdadasdasdas</td>
                    </tr>
                  ))}
                </tbody>
              </table>
